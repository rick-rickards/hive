...
process.loaded = process.loaded || new Date().getTime();

console.log('[[LOADING - HIVE]]', process.loaded);
			...
			try {
				if(isDir) {
					...
					refOnly
						...
						target[type][name] = {}
						:
						target[type][name] = require(path + '/' + file); //hive.require(path + '/' + file, binding);
